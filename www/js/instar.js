...
$("#detect-area").css("height", $(window).width()+200);
...
$(".modal").on("posthide",function(){
//clearInterval(startEff1);clearInterval(startEff2);clearInterval(startEff3);swipe_effect.destroy();$(".sketch").remove();$('#sketch_wrapper').remove();
