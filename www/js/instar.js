...
quote_array["de"] = ["Ich bin dann mal gl�cklich."];
quote_array["de"] = ["gl�cklich"];
quote_array["de"] = ["Du bist am sch�nsten, wenn du gl�cklich bist."];
quote_array["de"] = ["Gl�ckfinder"];
quote_array["de"] = ["Du machst mich gl�cklich!"];
quote_array["de"] = ["Hauptsache gl�cklich!"];
